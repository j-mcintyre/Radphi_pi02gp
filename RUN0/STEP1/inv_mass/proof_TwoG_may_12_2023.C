...
//    This files name    --> proof_TwoG_may_12_2023
//    TSelector Name     --> TwoG_may_12_2023
//
//   ///////////////// For MC Data ///////////////////
...
void proof_TwoG_may_12_2023(int nevents=2000000000)
{
   TChain *ch=fullchain();
   ...
   ch->SetProof();
#else
   gROOT->ProcessLine(".L TwoG_may_12_2023.C+O");
#endif

   ch->Process("TwoG_may_12_2023", "", nevents);
